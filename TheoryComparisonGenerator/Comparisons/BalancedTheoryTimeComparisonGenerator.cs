...
{
    class BalancedTheoryTimeComparisonGenerator : ITheoryComparisonGenerator
    {
        public IRun Run { get; set; }
        public string Name => Data.FormattedName;
        public const double Weight = 0.9375;

        public BalancedTheoryTimeComparisonGenerator(IRun run, ComparisonData data)
        {
            Run = run;
            Data = data;
        }
        ...
        public void Generate(TimingMethod method)
        {
            ...
            TimeSpan? goalTime = Data.TargetT[method];
